...
public abstract class GuiConfigsMixin_LitematicaProtocolCompat extends GuiConfigsBase
{
	...
	public int initGui(GuiConfigs instance, int x, int y, int width, GuiConfigs.ConfigGuiTab tab, Operation<Integer> original, @Local(name = "x") int guiX, @Local(name = "y") int guiY)
	{
