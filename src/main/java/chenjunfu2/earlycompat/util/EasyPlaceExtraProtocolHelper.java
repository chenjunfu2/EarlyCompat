...
public class EasyPlaceExtraProtocolHelper
{
	...
	public static byte getExtraProtocolRawValue(int protocolValue)
	{
		return (byte)(((protocolValue & 0b1111_0000) >>> 1) | (protocolValue & 0b0000_0111));//摘除bit3，拼接剩余位，一共剩余7bit可用
	}
}
